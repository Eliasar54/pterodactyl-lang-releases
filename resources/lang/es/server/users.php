...
return [
    'permissions' => [
        ...
        'control_kill' => 'Permite al usuario finalizar la instancia del servidor.',
        ...
        'schedule_read' => 'Permite al usuario ver los horarios para un servidor.',
        'schedule_update' => 'Permite al usuario realizar modificaciones en un horario existente del servidor.',
        'schedule_delete' => 'Permite al usuario eliminar un horario para el servidor.',
    ],
];